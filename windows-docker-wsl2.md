...
*NOTE* If on older WSL/ubuntu (i.e. 22) and PNNL resources are needed (i.e. for Atlas) try this resolve.conf copied from Chandrika's WSL2 / Ubuntu 24:
```
chandrika@PNNL-FZG16J4:~/atlas/msdlive-platform$ cat /etc/resolv.conf
